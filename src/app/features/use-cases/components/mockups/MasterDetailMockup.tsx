                      ...
                      <div className="bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-2xl overflow-hidden p-4 min-h-[160px]">
                        <AnimatePresence mode="wait">
                          {activeDetailTab === 'items' && (
                            ...
                            >
                              ...
                              <div className="grid grid-cols-3 text-xs">
                                ...
                                <span className="text-right text-neutral-600 dark:text-neutral-400">R$ 435,00/m├¬s</span>
                              </div>
                            </motion.div>
                          )}
                          ...
                          {activeDetailTab === 'logs' && (
                            ...
                            >
                              <p>[2026-05-21 15:30] Ô£ô Conectado com sucesso via T├║nel Seguro.</p>
                              <p>[2026-05-21 14:12] ­ƒôØ Registro alterado por administrador@empresa.com</p>
                              <p>[2026-05-20 09:41] ­ƒÜÇ Mapeamento sem├óntico de relacionamentos (FK) atualizado.</p>
                            </motion.div>
                          )}
                        </AnimatePresence>
                      </div>
