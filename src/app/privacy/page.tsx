    ...
    <main className="min-h-screen bg-black text-white p-8 md:p-24 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto space-y-12 relative z-10">
        ...
        <div className="space-y-4">
          <h1 className="text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-neutral-500">{t('privacy.title')}</h1>
          <p className="text-neutral-500 font-medium">{t('privacy.version')} • Maio 2026</p>
        </div>
