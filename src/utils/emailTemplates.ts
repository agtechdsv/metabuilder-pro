export type EmailTemplateType = 'free' | 'modern' | 'alert' | 'classic';

export function wrapEmailInTemplate(templateType: EmailTemplateType, bodyHtml: string): string {
  // Converte quebras de linha para <br/> caso o usuário não tenha escrito HTML
