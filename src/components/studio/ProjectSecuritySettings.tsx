...
export function ProjectSecuritySettings({ project, canEdit }: ProjectSecuritySettingsProps) {
  ...
  const [traditionalLogin, setTraditionalLogin] = useState(initialSecurity.traditional_login !== false)
  const [googleLogin, setGoogleLogin] = useState(initialSecurity.google_login !== false)
  ...
  const handleSave = async () => {
    ...
    try {
      const newConfig = {
        ...
        security: {
          traditional_login: traditionalLogin,
