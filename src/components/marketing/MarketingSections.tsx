  ...
  return (
    <div className="w-full space-y-32 py-20 px-6">
      ...
      <section className="max-w-7xl mx-auto py-10">
        <div className="bg-white dark:bg-black text-black dark:text-white rounded-[3rem] p-12 md:p-20 relative overflow-hidden flex flex-col md:flex-row items-center gap-12 border border-neutral-200 dark:border-neutral-800 shadow-xl dark:shadow-2xl">
          <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-br from-indigo-500/10 to-purple-500/10 dark:from-indigo-500/20 dark:to-purple-500/20 rounded-full blur-[120px] pointer-events-none transform translate-x-1/2 -translate-y-1/2"></div>
          ...
          <div className="w-full md:w-[400px] relative z-10 shrink-0 hidden lg:block">
            <div className="absolute inset-0 bg-gradient-to-t from-white dark:from-black via-transparent to-transparent z-10 h-full w-full pointer-events-none"></div>
            <div className="bg-neutral-50 dark:bg-[#1e1e1e] p-6 rounded-3xl border border-neutral-200 dark:border-neutral-800 shadow-xl dark:shadow-2xl font-mono text-sm text-neutral-500 dark:text-neutral-400 space-y-4 opacity-90 transform -rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="space-y-2">
                <p className="text-emerald-600 dark:text-emerald-400">$ git merge upstream</p>
                <p>Auto-merging src/app/page.tsx</p>
                <p>Merge made by the 'ort' strategy.</p>
                <p className="text-neutral-400 dark:text-neutral-600 mt-4"># Testando em sync-sandbox</p>
                <p className="text-neutral-400 dark:text-neutral-600"># Se aceito:</p>
                <p className="text-indigo-600 dark:text-indigo-400">$ git checkout local</p>
                <p className="text-indigo-600 dark:text-indigo-400">$ git merge sync-sandbox</p>
              </div>
            </div>
          </div>
        </div>
