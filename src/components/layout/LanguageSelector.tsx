      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-56 bg-white dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.3)] overflow-hidden z-[100]"
          >
            <div className="p-2">
