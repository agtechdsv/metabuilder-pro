...
export function UserMenu({ user, profile: initialProfile }: UserMenuProps) {
  ...
  const handleSignOut = async () => {
    try {
      ...
      // Redirecionamento forçado via browser para limpar tudo
  ...
  return (
    ...
    >
      <div
        className="flex items-center gap-3 p-1 pr-3 rounded-full bg-neutral-900/50 border border-neutral-800 hover:border-neutral-700 transition-all group cursor-default"
      >
        <div className="relative">
          ...
          <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-neutral-900 border border-neutral-800 rounded-full flex items-center justify-center text-[8px] text-neutral-400 group-hover:text-white transition-colors">
        ...
        <ChevronDown className={cn("w-3.5 h-3.5 text-neutral-500 transition-transform duration-300", isOpen && "rotate-180")} />
      </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 pt-2 w-64 z-[100]"
          >
            <div className="bg-neutral-950 border border-neutral-800 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden">
              <div className="p-5 border-b border-neutral-800 bg-neutral-900/30">
                <span className="text-[9px] font-bold text-neutral-500 uppercase tracking-widest mb-2 block">Usuário Logado</span>
              ...
              <div className="p-2">
                ...
                >
                  <div className="p-2 bg-blue-500/10 rounded-lg group-hover:bg-blue-500/20 transition-all text-blue-500">
                ...
                {isCustomAvatar && (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-neutral-300 hover:text-white transition-all group"
                  >
                    <div className="p-2 bg-neutral-800 rounded-lg group-hover:bg-blue-500/20 transition-all text-neutral-400 group-hover:text-blue-500">
                      <RefreshCcw className="w-4 h-4" />
                    </div>
                    <span className="text-sm font-medium">Restaurar foto do Google</span>
                  </button>
                )}
              </div>

              <div className="p-2 border-t border-neutral-800 bg-neutral-900/10">
                <button
                  onClick={handleSignOut}
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-red-500/10 text-neutral-400 hover:text-red-400 transition-all group"
                >
                  <div className="p-2 bg-neutral-800 group-hover:bg-red-500/20 rounded-lg transition-all text-neutral-400 group-hover:text-red-500">
